...
my_tesla = EletricCar('tesla','model-sss',2020)
print(my_tesla.get_descriptive_name())
my_tesla.read_gas_tank()
my_tesla.increment_gas_tank(69)
my_tesla.read_gas_tank()
my_tesla.fill_gas_tank()
# read_gas_tank nao se aplicaria a esse objeto, pois só pertence a super classe
my_tesla.read_gas_tank()

# aqui eu chamei a instancia my_tesla, e depois a instancia batery_size junto com seu metodo
my_tesla.batery_size.describe_batery()

my_tesla.batery_size.range_batery()
